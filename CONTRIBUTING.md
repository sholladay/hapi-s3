...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/sholladay/hapi-s3/labels/bug) and [easy](https://github.com/sholladay/hapi-s3/labels/easy) vs [hard](https://github.com/sholladay/hapi-s3/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
